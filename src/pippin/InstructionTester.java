...
public class InstructionTester {
	...
	@Test 
	// this test checks whether the copy is done correctly
	public void testCOPY() {
		Instruction instr = machine.get(0x1D);
		machine.setData(0, 4);
		machine.setData(1, 8);
		machine.setData(2, 3);
		machine.setData(4, 15);
		machine.setData(5, 16);
		machine.setData(6, 17);

		int arg = 0; 
		machine.setAccumulator(200);
		instr.execute(arg); 

		assertEquals(15, machine.getData(8));
		assertEquals(16, machine.getData(9));
		assertEquals(17, machine.getData(10));
	}

	@Test 
	// this test checks whether the copy is done correctly, when
	// addressing is indirect
	...
	@Test 
	// this test checks whether the copy is done correctly after overlap
	public void testCOPYoverlap() {
		...
		assertEquals(15, machine.getData(5));
		assertEquals(16, machine.getData(6));
		assertEquals(17, machine.getData(7));
	}
	
	@Test(expected=IllegalArgumentException.class)
	// this test checks whether the copy gives illegal argument exception 
	// because of overlap with arg
	public void testCOPYexcepARG() {
		Instruction instr = machine.get(0x1D);
		machine.setData(0, 2);
		machine.setData(1, 4);
		machine.setData(2, 3);
